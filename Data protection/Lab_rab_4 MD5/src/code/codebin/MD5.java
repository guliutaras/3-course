...
public class MD5 {
    ...
    public static String Encode(String Messege) {
        ...
        try {
            byte[] Mtemp = Messege.getBytes("Cp1251");
            ...
            result = result + Long.toHexString(A) + Long.toHexString(B) + Long.toHexString(C) + Long.toHexString(D);
        }catch (UnsupportedEncodingException e){System.out.println("Не поддерживаеться!");}
        return result;
        }
    }
